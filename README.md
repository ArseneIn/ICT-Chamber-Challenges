...
```
ICT-Chamber-Challenges/
├── README.md                      # Workspace index & guidelines
├── .gitignore                     # Global git ignore configuration
├── challenge-01-<name>/           # Challenge #1 project files
├── challenge-02-<name>/           # Challenge #2 project files
└── ...
```
...
|---|----------------|------|------------|--------|-----------|
| 01 | *Upcoming Challenge #1* | TBD | TBD | 🟡 In Progress | [`./challenge-01`](./) |
...
3. **Environment Variables**: Store API keys in `.env.local` inside individual challenge subfolders (never commit secrets to git).

---
*Maintained for ICT Chamber Challenge submissions.*
